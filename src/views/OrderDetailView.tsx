            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="flex flex-col gap-4 items-center">
                  ...
                  <button
                    className="bg-emerald-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed inline-flex items-center space-x-2"
                    disabled={
                      !order?.croppedNoBgNoWatermarkImageUrl ||
